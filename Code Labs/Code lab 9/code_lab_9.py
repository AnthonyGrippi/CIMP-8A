...
# Returns:
# ================================================================ # 
def welcome_message(start_time):

    print("BLACKJACK!")
    print("Blackjack payout is 3:2")
    print("Enter \'x\' for bet to exit")
    print("Start Time: ", start_time.strftime("%I:%M:%S %n"))
...
def get_starting_amount():
    ...
    try:
        ...
        print("Data File is missing, resetting game.")
        player_money = 1000
    ...
    print("Money", lc.currency(player_money, grouping=True))
    print()
    return player_money
# ================================================================ #
...
def main():
    ...
    while True:
        ...
        print("Money", lc.currency(round(current_money, 2), grouping=True))
        print()
